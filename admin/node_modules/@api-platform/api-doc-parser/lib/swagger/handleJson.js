...
export default function handleJson(response, entrypointUrl) {
    ...
    return paths.map((path) => {
        ...
        const fields = Object.entries(properties).map(([fieldName, property]) => new Field(fieldName, {
            id: null,
            range: null,
            type: getType(typeof property?.type === "string" ? property.type : "", property?.["format"] ?? ""),
