...
interface NonArraySchemaObjectDereferenced extends BaseSchemaObjectDereferenced {
    type?: OpenAPIV3.NonArraySchemaObjectType;
}
export type SchemaObjectDereferenced = ArraySchemaObjectDereferenced | NonArraySchemaObjectDereferenced;
type BaseSchemaObjectDereferenced = Omit<OpenAPIV3.BaseSchemaObject, "additionalProperties" | "properties" | "allOf" | "oneOf" | "anyOf" | "not"> & {
...
type MediaTypeObjectDereferenced = Omit<OpenAPIV3.MediaTypeObject, "schema" | "encoding"> & {
    schema?: SchemaObjectDereferenced;
    encoding?: {
        [media: string]: EncodingObjectDereferenced;
    };
};
type ParameterBaseObjectDereferenced = Omit<OpenAPIV3.ParameterObject, "schema" | "content"> & {
    schema?: SchemaObjectDereferenced;
    content?: {
...
type RequestBodyObjectDereferenced = Omit<OpenAPIV3.RequestBodyObject, "content"> & {
    content: {
        [media: string]: MediaTypeObjectDereferenced;
    };
};
type ResponseObjectDereferenced = Omit<OpenAPIV3.ResponseObject, "headers" | "content"> & {
    headers?: {
        [header: string]: HeaderObjectDereferenced;
    };
    content?: {
...
type PathItemObjectDereferenced<T extends object = object> = Omit<OpenAPIV3.PathItemObject, "parameters" | `${OpenAPIV3.HttpMethods}`> & {
...
export type OperationObjectDereferenced<T extends object = object> = Omit<OpenAPIV3.OperationObject, "parameters" | "requestBody" | "responses" | "callbacks"> & {
    parameters?: ParameterObjectDereferenced[];
...
interface PathsObjectDereferenced<T extends object = object, P extends object = object> {
    [pattern: string]: (PathItemObjectDereferenced<T> & P) | undefined;
}
type ComponentsObjectDereferenced = Omit<OpenAPIV3.ComponentsObject, "schemas" | "responses" | "parameters" | "requestBodies" | "headers" | "callbacks"> & {
    schemas?: {
...
export type OpenAPIV3DocumentDereferenced<T extends object = object> = Omit<OpenAPIV3.Document, "paths" | "components"> & {
    paths: PathsObjectDereferenced<T>;
    components?: ComponentsObjectDereferenced;
};
export {};
//# sourceMappingURL=dereferencedOpenApiv3.d.ts.map