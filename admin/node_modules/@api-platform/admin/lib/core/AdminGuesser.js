...
import { AdminContext, Loading, defaultI18nProvider, 
...
const AdminGuesser = (_a) => {
    ...
    error = DefaultError, store = defaultStore, dataProvider, i18nProvider = defaultI18nProvider, authProvider, queryClient, defaultTheme, layout = Layout, loginPage = LoginPage, loading: LoadingPage = Loading, theme = defaultLightTheme, darkTheme = defaultDarkTheme, 
    // Other props
