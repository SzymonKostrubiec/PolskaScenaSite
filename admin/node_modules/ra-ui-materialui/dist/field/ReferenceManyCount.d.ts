...
export interface ReferenceManyCountProps<RecordType extends RaRecord = RaRecord> extends Omit<FieldProps<RecordType>, 'source'>, Omit<ReferenceManyCountBaseProps, 'record'>, Omit<TypographyProps, 'children' | 'textAlign'> {
    link?: boolean;
}
