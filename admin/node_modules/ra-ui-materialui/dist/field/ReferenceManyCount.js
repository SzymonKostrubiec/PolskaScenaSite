...
export const ReferenceManyCount = (inProps) => {
    ...
    const body = (React.createElement(ReferenceManyCountBase, { ...props, loading: React.createElement(CircularProgress, { size: 14 }), error: React.createElement(ErrorIcon, { color: "error", fontSize: "small", titleAccess: "error" }), offline: offline, render: render }));
