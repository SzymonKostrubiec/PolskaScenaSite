...
import { Button, Snackbar, major as muiMajor, } from '@mui/material';
 ...
 */
export const Notification = (inProps) => {
    ...
    return (React.createElement(CloseNotificationContext.Provider, { value: handleRequestClose },
        React.createElement(StyledSnackbar, { className: className, open: open, message: message &&
            ...
            autoHideDurationFromMessage === undefined
                ? autoHideDuration
                : autoHideDurationFromMessage ?? undefined, disableWindowBlurListener: undoable, TransitionProps: transitionProps, ContentProps: contentProps, onClose: handleRequestClose, action: undoable ? (React.createElement(Button, { color: "primary", className: NotificationClasses.undo, size: "small", onClick: handleUndo },
                React.createElement(React.Fragment, null, translate('ra.action.undo')))) : null, anchorOrigin: anchorOrigin, ...rest, ...options, ...(muiMajor >= 6 ? { slotProps: mergedSlotProps } : {}) }, message &&
            typeof message !== 'string' &&
