...
export const Pagination = memo(props => {
    ...
    if (isSmall) {
        return (React.createElement(TablePagination, { count: total == null ? -1 : total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, rowsPerPageOptions: emptyArray, component: "span", labelDisplayedRows: labelDisplayedRows, slotProps: slotProps, ...sanitizeListRestProps(rest) }));
    }
    ...
    return (React.createElement(TablePagination, { count: total == null ? -1 : total, rowsPerPage: perPage, page: page - 1, onPageChange: handlePageChange, onRowsPerPageChange: handlePerPageChange, 
        // @ts-ignore
        ActionsComponent: ActionsComponent, slotProps: mergedSlotProps, component: "span", labelRowsPerPage: translate('ra.navigation.page_rows_per_page'), labelDisplayedRows: labelDisplayedRows, getItemAriaLabel: labelItem, rowsPerPageOptions: rowsPerPageOptions, ...sanitizeListRestProps(rest) }));
});
