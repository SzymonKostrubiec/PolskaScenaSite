import { Autocomplete, Chip, createFilterOptions, TextField, major as muiMajor, useForkRef, } from '@mui/material';
    ...
    const renderChips = (value, getProps) => value.map((option, index) => {
        ...
        return (React.createElement(Chip, { label: isValidElement(optionText)
                ? inputText
                    ? inputText(option)
                    : ''
                : getChoiceText(option), size: "small", key: key, ...chipProps, ...mergedSlotProps }));
    });
        ...
        React.createElement(StyledAutocomplete, { className: clsx('ra-input', `ra-input-${source}`, className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), loadingText: isPaused && isPlaceholderData
                ...
                ? // In MUI v7, renderValue replaces renderTags, but it is also
                    ...
                    multiple
                        ...
                        : {}
                : { renderTags: renderChips }), noOptionsText: typeof noOptionsText === 'string'
